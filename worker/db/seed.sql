...
INSERT INTO games (id, opponent, date, time, location, field_name, result, score_us, score_them) VALUES
  (1, 'Tigers', '2025-04-05', '10:00 AM', 'Lions Park', 'Lions 4', 'W', 5, 3),
  (2, 'Yankees', '2025-04-12', '10:00 AM', 'Marsh Creek Park', 'Marsh Creek', NULL, NULL, NULL);
...
INSERT INTO fields (name, date, time_slot, status) VALUES
  ('Lions 4', '2025-04-12', '9AM-12PM', 'Available'),
  ('Cedar Hills', '2025-04-12', '2PM-5PM', 'Available'),
  ('Marsh Creek', '2025-04-13', '10AM-1PM', 'Booked');

-- Confirmed WebTrac name mappings (page 1 verified March 2026)
INSERT INTO dim_field_aliases (tracked_name, webtrac_name, confirmed) VALUES
